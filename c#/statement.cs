...
Next unit: Exercise - Create decision logic with if statements
*/
...
In the Open Folder dialog, navigate to the Windows Desktop folder.
...
In the Open Folder dialog, select Select Folder.
...
Delete the existing code lines.
